...
interface Business { id: string; name: string; location: string; town: string; phone: string; category: string; description: string; image: string; isOpen: boolean; seating: string[]; products: Product[]; }

export default function StoreClient({ store }: { store: Business }) {
  return (
